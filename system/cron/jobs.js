...
export const dailyMeme = new Cron.CronJob(
    ...
    async () => {
        ...
        switch (d.getDay()) {
            case 0:
                await discordMsg('https://twitter.com/ItBeSunday/status/1368586237926383616');
                break;
            case 1:
                await discordMsg('https://twitter.com/RiseMonday/status/1368849138708848643');
                break;
            case 2:
                await discordMsg('https://twitter.com/tuesdaymateys/status/1369154910353252355');
                break;
            case 3:
                await discordMsg('https://twitter.com/SailerWednesday/status/1369585318370762752');
                break;
            case 4:
                await discordMsg('https://twitter.com/ThursdaySailer/status/1367369219185119237');
                break;
            case 5:
                await discordMsg('https://twitter.com/FridaySailer/status/1367822956362035200');
                break;
            case 6:
                await discordMsg('https://twitter.com/SaturdaySailer/status/1368171736034906112');
                break;
            default:
                break;
        }
...
async function discordMsg(channel, url) {
    let webhook;
